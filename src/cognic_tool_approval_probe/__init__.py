"""cognic-tool-approval-probe — Cognic AgentOS MCP tool pack.
...
class _ServerDescriptor:
    """Inert marker. The real server lives in cognic_tool_approval_probe.server."""

    cognic_pack_kind: str = "mcp_server"
    pack_id: str = "cognic-tool-approval-probe"
